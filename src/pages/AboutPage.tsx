...
//       image: "/lovable-uploads/2465b8ef-ffa2-4215-9766-b49d41a0665c.png",
...
// Add this CSS for collapsible functionality
import { useEffect } from "react"

const AboutPage = () => {
  // Add this effect to apply custom CSS for collapsible elements
  useEffect(() => {
    ...
    style.textContent = `
      ...
      [data-state="open"] p.line-clamp-2 {
        display: none;
      }
    `
  ...
  const timeline = [
    ...
    },
    {
      ...
      title: "Expansion to Madurai",
      description:
        "Relocated to Madurai and established as a professional IT service company with expanded operations.",
      icon: <Building className="text-magizh-purple" />,
    },
    {
      year: 2023,
  ...
  const leadership = [
    {
      ...
      image: "/lovable-uploads/f989be9d-7bb0-4982-93fe-adabd5ab7f72.png",
      description:
        "With over 15 years of experience in the IT industry, Udhayaseelan founded Magizh NexGen Technologies with a vision to deliver innovative digital solutions that empower businesses across the globe.",
    },
    {
      name: "Rahavi Udhayaseelan",
      role: "CEO & Managing Director",
      image: "/lovable-uploads/df0f513c-5b55-4033-a587-aca4ed23b5ec.png",
      description:
        "As CEO, Rahavi leads the company's strategic direction and business operations. Her expertise in project management and client relations has been instrumental in the company's rapid growth and success.",
    },
    {
      name: "Sunmathi Loganathan",
      role: "Director of Administration",
      image: "/lovable-uploads/a1575d0b-acc4-4816-bb8f-1364a92de3d0.png",
      description:
        "Sunmathi oversees all administrative functions and ensures smooth day-to-day operations. Her organizational skills and attention to detail create an efficient work environment that supports the entire team.",
    },
    {
      name: "Abirami Chandresh",
      role: "Director of Sales",
      image: "/lovable-uploads/2465b8ef-ffa2-4215-9766-b49d41a0665c.png",
      description:
        "With her exceptional interpersonal skills and market knowledge, Abirami spearheads the company's sales initiatives and client acquisition strategies, helping expand our reach across various industries.",
    },
  ]
    ...
    <div className="min-h-screen flex flex-col">
            ...
            {leadership.map((leader, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <Collapsible>
                    <div className="text-gray-600 text-sm">
                      <p className="line-clamp-2 collapsible-closed">{leader.description}</p>
                    </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10">
            Meet the talented professionals who make up our diverse and skilled team, committed to delivering
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="aspect-square relative bg-gradient-to-br from-magizh-light to-white overflow-hidden">
                  ...
                  />
                  <div className="hidden w-full h-full items-center justify-center text-2xl font-bold bg-gradient-to-br from-magizh-blue/20 to-magizh-purple/20 text-magizh-blue">
                    {member.fallback}
                  </div>
                </div>
                  ...
                  <div className="mt-2 pt-2 border-t border-gray-100 flex justify-between items-center">
                    <div className="flex gap-1">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="rounded-full p-0 h-6 w-6 flex items-center justify-center text-gray-500 hover:text-magizh-blue hover:bg-magizh-light/50"
                      >
                        <div className="sr-only">LinkedIn</div>
                        <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
